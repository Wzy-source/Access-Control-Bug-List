  ...
  ReentrancyGuard
{
  ...
  function _singleLeverUp(
    ...
    require(
      erc20Token.balanceOf(address(activePool)) ==
  ...
  function _singleUnleverUp(
    ...
    _finalYUSDAmount = router.unRoute(
      address(this),
      _token,
    ...
    require(
      yusdTokenCached.balanceOf(address(this)) ==
  ...
  function _getTotalVariableDepositFee(
    ...
    for (uint256 i; i < tokensLen; ++i) {
      ...
      whitelistFee = whitelist.getFeeAndUpdate(
        vars.token,
