  ...
  ReentrancyGuard
{
    ...
    returns (uint256 liquidity)
  {
    ...
    require(liquidity > 0, "BasePoolV2::mint: Insufficient Liquidity Provided");
  ...
  function _update(
    ...
    require(
      balanceNative <= type(uint112).max && balanceForeign <= type(uint112).max,
