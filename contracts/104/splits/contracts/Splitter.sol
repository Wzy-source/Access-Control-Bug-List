...
contract Splitter is SplitStorage {
  ...
  function getNode(
    ...
    return keccak256(abi.encodePacked(who, percentageAllocation));
  }
   ...
   */
  function isClaimed(address who, uint256 window) public view returns (bool) {
   ...
   * @param window {uint256} Window to check
   */
  function setClaimed(address who, uint256 window) private {
